...
const Map<int, int> unicodeToMenksoftPunctuation = {
  ...
  Unicode.FULLWIDTH_RIGHT_PARENTHESIS: Menksoft.RIGHT_PARENTHESIS,
  ...
  Unicode.LEFT_DOUBLE_ANGLE_BRACKET: Menksoft.LEFT_DOUBLE_ANGLE_BRACKET,
  Unicode.RIGHT_DOUBLE_ANGLE_BRACKET: Menksoft.RIGHT_DOUBLE_ANGLE_BRACKET,
  Unicode.LEFT_ANGLE_BRACKET: Menksoft.LEFT_ANGLE_BRACKET,
  Unicode.RIGHT_ANGLE_BRACKET: Menksoft.RIGHT_ANGLE_BRACKET,
  Unicode.VERTICAL_LEFT_WHITE_CORNER_BRACKET:
      Menksoft.LEFT_WHITE_CORNER_BRACKET,
  Unicode.VERTICAL_RIGHT_WHITE_CORNER_BRACKET:
      Menksoft.RIGHT_WHITE_CORNER_BRACKET,
