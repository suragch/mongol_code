...
class Menksoft {
  ...
  static const int FINA_UE_FVS1_BP = 0xE2A5; // tooth
  static const int FINA_UE_FVS2 = 0xE2A6; // gedes
  static const int FINA_UE_FVS2_BP = 0xE2A7; // no tooth
  ...
  static const int MEDI_NA_TOOTH = 0xE2B8; // undotted
  static const int MEDI_NA_STEM = 0xE2BA; // undotted
  static const int MEDI_NA_FVS1_TOOTH = 0xE2B7; // dotted
  static const int MEDI_NA_FVS1_STEM = 0xE2B9; // dotted
  ...
  static const int INIT_GA_TOOTH = 0xE2E1; // dotted
  static const int INIT_GA_STEM = 0xE2E4; // dotted
  ...
  static const int INIT_GA_FVS2 = 0xE2E3; // feminine
  static const int INIT_GA_FVS2_OU = 0xE2E6; // feminine
  ...
  static const int MEDI_GA = 0xE2EE; // two teeth no dots
  static const int MEDI_GA_FVS1_TOOTH = 0xE2EA; // dotted two teeth
  static const int MEDI_GA_FVS1_STEM = 0xE2EC; // dotted two teeth
  static const int MEDI_GA_FVS2 = 0xE2EB; // feminine
  static const int MEDI_GA_FVS2_OU = 0xE2ED; // feminine
  ...
  static const int INIT_DA_FVS1 = 0xE310; // left arm with loop
